...
class TapScale extends StatefulWidget {
  ...
  const TapScale({required this.child, this.onTap, this.onLongPress,
      this.scale = 0.96, super.key});
...
class _TapScaleState extends State<TapScale> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTapDown: (_) { if (widget.onTap != null || widget.onLongPress != null) _ctrl.forward(); },
