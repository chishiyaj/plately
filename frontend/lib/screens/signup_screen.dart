...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _createAccount() async {
    ...
    if (email.isEmpty || !RegExp(r'^[^@\s]+@[^@\s]+\.[^@\s]+$').hasMatch(email)) {
      _showError('Enter a valid email address.'); return;
    }
    ...
    if (result.success) {
      setState(() { _verificationSent = true; _sentToEmail = email; });
    } else {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Create\naccount', style: TextStyle(
              color: AppTheme.textPrimary(context), fontSize: 36,
              fontFamily: 'DM Sans', fontWeight: FontWeight.w800, height: 1.1,
            )).animate().fadeIn(duration: 400.ms, delay: 80.ms).slideY(begin: 0.08),
            const SizedBox(height: 8),
            Text('Join thousands cooking smarter.', style: TextStyle(
              color: AppTheme.textMuted(context), fontSize: 15, fontFamily: 'DM Sans',
            ...
            Column(children: [
              ...
              _field(
                ...
                suffix: SizedBox(width: 48, height: 48,
                  child: TapScale(
              ...
              child: Row(children: [
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: _agreed ? AppTheme.primaryDark : AppTheme.border(context),
                      width: 1.5,
                    ),
                  ),
            ...
            TapScale(
              ...
              child: AnimatedContainer(
                duration: 250.ms, width: double.infinity, height: 56,
                decoration: BoxDecoration(
                  gradient: _agreed ? AppTheme.tealGradient : null,
                  color: _agreed ? null : AppTheme.border(context),
                ...
                child: Center(child: _loading
                    ...
                    : Text('Create Account', style: TextStyle(
                        color: _agreed ? Colors.white : AppTheme.textMuted(context),
        ...
        child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text('Check your email!', textAlign: TextAlign.center,
              style: TextStyle(color: AppTheme.textPrimary(context), fontSize: 28,
            ...
            Container(
              ...
              child: const Row(children: [
                ...
                Expanded(child: Text(
                  ...
                  style: TextStyle(color: Color(0xFF2E6B29), fontSize: 13,
                      fontFamily: 'DM Sans', height: 1.4),
                )),
              ]),
            ...
            TapScale(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [BoxShadow(color: Color(0x44043B3C), blurRadius: 18, offset: Offset(0, 6))],
                ),
                child: const Center(child: Text('Go to Login', style: TextStyle(
